...
public final class JourneyDtos {
    ...
    public record CaseView(UUID id,String caseNumber,String status,String patientName,String country,String preferredLanguage,Instant createdAt,Instant updatedAt,long version,String coordinatorSubject,String doctorSubject) {}
