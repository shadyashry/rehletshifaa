...
public final class JourneyDtos {
    ...
    public record ServiceTemplateView(UUID id,String careCategory,String name,String referenceStandard,String guidanceNote) {}
    public record ServiceTemplateItemView(String serviceCode,String serviceName,String category,BigDecimal suggestedPriceEgp,int sortOrder,boolean active) {}
    public record ServiceTemplateUpdateRequest(@NotBlank @Size(max=160)String name,@Size(max=300)String referenceStandard,@Size(max=1000)String guidanceNote) {}
