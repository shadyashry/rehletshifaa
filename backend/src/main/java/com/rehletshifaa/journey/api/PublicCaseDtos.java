...
public final class PublicCaseDtos {
    ...
    public record PublicCaseStatus(String caseNumber,String statusEn,String statusAr,String phase,boolean actionRequired,WorkDtos.PatientActionView action) {}
