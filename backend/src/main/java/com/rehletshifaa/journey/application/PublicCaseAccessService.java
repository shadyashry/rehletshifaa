...
public class PublicCaseAccessService {
     ...
     * code for THIS case, so the current decidable version is opened without a second code. Which version is
     * decided by {@link ProposalAccessService}; nothing about the request can point at another case or version.
     */
